<template>
  <div
    class="modal fade"
    id="kt_modal_add_productionActivity"
    ref="addProductionActivityModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_productionActivity_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Add a production activity</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div
            id="kt_modal_add_productionActivity_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div
              ...
              id="kt_modal_add_productionActivity_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_add_productionActivity_header"
              data-kt-scroll-wrappers="#kt_modal_add_productionActivity_scroll"
          ...
          <div class="modal-footer flex-center">
            ...
            <button
              type="reset"
              id="kt_modal_add_productionActivity_cancel"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const addProductionActivityModalRef = ref<null | HTMLElement>(null);
