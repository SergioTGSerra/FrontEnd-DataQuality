          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            >
              ...
              <div
                ...
                href="#kt_modal_add_metric_billing_info"
                role="button"
                aria-expanded="false"
                aria-controls="kt_metric_view_details"
              >
              ...
              <!--begin::Billing form-->
              <div
                id="kt_modal_add_metric_billing_info"
                class="collapse show"
              >
                <!--begin::Input group-->
                  ...
                  <div class="d-flex flex-stack">
                    ...
                    >
                      ...
                      <input
                        ...
                        type="checkbox"
                        value="1"
                        id="kt_modal_add_metric_billing"
                        checked
                      />
                      <!--end::Input-->
                      ...
                      <span
                        ...
                        for="kt_modal_add_metric_billing"
                      >
                        Yes
                      </span>
                      <!--end::Label-->
  ...
  setup() {
    ...
    const rules = ref({
      ...
      email: [
        {
          required: true,
          message: "Metric email is required",
          trigger: "change",
        },
      ],
      addressLine: [
